...
<script>
  import { listBloodSugarByUserId, listUricAcidByUserId, listCholesterolByUserId, listGlycerinByUserId, listBodyTemperatureByUserId, wxLogin} from '@/api/health/api'
